...
selector = {
    ...
    "rf" : ['P1', 'P2', 'P3', 'P4', 'P5', 'P6', 'P7', 'P8', 'P9', 'P10', 'P11', 'P12', 'P13', 'P14', 'P15', 'P16', 'P17', 'P19', 'P20', 'P21', 'P22', 'P24', 'P25', 'P26', 'P27', 'P28', 'P29', 'P30', 'P31', 'P32', 'P33', 'P35', 'P36', 'P37', 'is_big_city', 'start_year', 'start_month', 'start_day', 'num_years', 'num_months', 'Type_Rest'],
}
...
if __name__ == '__main__':
    ...
    clf_outliers = SimpleBlendedClassifier(
         clf_list=[
                  ...
                  # BaggingRegressor(SVR(C=0.6,degree=5,epsilon=0.2,gamma=0.09),n_estimators=1000,n_jobs=-1),
                  # BaggingClassifier(SVC(C=0.6,degree=5,gamma=0.09,probability=True),n_estimators=1000,n_jobs=-1),
                  SVC(C=0.6,degree=5,gamma=0.09),
                  ],
        clf_weights=[1,1],
        feat_sel=[
            selector["linear"],
    ...
    make_submission("added_num_years_feat.csv",ypred_blendedclf)
